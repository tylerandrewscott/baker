...
form1 = net_list[-1] ~ edges  + 
  ...
  timecov(minimum = 11,maximum = 17, transform = function(t) 1) +
  timecov(minimum = 18, transform = function(t) 1)+
  timecov(x = autoreg_list_prior, minimum = 6, maximum = 10, transform = function(t) 1) +
...
form2 = net_list[-1] ~ edges  + 
  ...
  timecov(minimum = 11,maximum = 17, transform = function(t) 1) +
  timecov(minimum = 18, transform = function(t) 1)+
  timecov(x = mandatory_list_odegree, minimum = 6, maximum = 10, transform = function(t) 1) +
...
form3 = net_list[-1] ~ edges  + 
  ...
  timecov(minimum = 11,maximum = 17, transform = function(t) 1) +
  timecov(minimum = 18, transform = function(t) 1)+
  timecov(x = utility_list_odegree, minimum = 6, maximum = 10, transform = function(t) 1) +
...
m0 = mtergm(form0,R=Rnum,parallel='multicore',ncpus=8)
#save.image('Scratch/temp_btergm_results.RData',compress = TRUE,safe=TRUE)
m1 = mtergm(form1,R=Rnum,parallel='multicore',ncpus=8)
#m2a = btergm(form2A,R=Rnum,parallel='multicore',ncpus=8)
#save.image('Scratch/temp_btergm_results.RData',compress = TRUE,safe=TRUE)
#m3 = btergm(form3,R=Rnum,parallel='multicore',ncpus=8)
#save.image('Scratch/temp_btergm_results.RData',compress = TRUE,safe=TRUE)
m2 = mtergm(form2,R=Rnum,parallel='multicore',ncpus=8)
#save.image('Scratch/temp_btergm_results.RData',compress = TRUE,safe=TRUE)
m3 = mtergm(form3,R=Rnum,parallel='multicore',ncpus=8)

save.image('Scratch/temp_mtergm_results.RData',compress = TRUE,safe=TRUE)
